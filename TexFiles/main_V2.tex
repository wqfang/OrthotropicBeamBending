...
\begin{figure}[t]
	...
	\includegraphics[width=0.8\textwidth]{schematic_V2.pdf}
...
\begin{equation}
	\begin{aligned}
	EI = & \sum_{n=1}^{N} \left[ \sum_{i \in \mathcal{L}} {}^{n}\!{\alpha_{i}} {}^{n}\!{K_{i}}  \pr{\p\pr{{}^{n-1}\!{r},{}^{n}\!{m_{i}}+2} - \p\pr{{}^{n}\!{r},{}^{n}\!{m_{i}} + 2}} + {}^{n}\!\gamma(\p\pr{{}^{n-1}\!{r},4} - \p\pr{{}^{n}\!{r},4}) \right],
	\end{aligned}
	\label{eq:EI}
\end{equation}
with
...
\begin{equation}
	\begin{aligned}
	EI & = \sum_{n=1}^{N} \left[ \sum_{i \in \mathcal{L}} \alpha_i \left( P_i \p\pr{{}^{n}\!{r},-m_i  + 2} + O(\Delta r) \right) (\p\pr{{}^{n-1}\!{r},{}^{n}\!{m_{i}} + 2} - \p\pr{{}^{n}\!{r},m_{i} +2}) \right] + \gamma (\p\pr{{}^{0}\!{r},4} - \p\pr{{}^{N}\!{r},4}) \\
	 & \begin{split}
		...
		+ \gamma (\p\pr{{}^{0}\!{r},4} - \p\pr{{}^{N}\!{r},4})
	   \end{split}\\
	 & = - \sum_{n=1}^{N} \left[ \sum_{i \in \mathcal{L}} \left( \alpha_i P_i (m_i + 2 ) \p\pr{{}^{n}\!{r},3} \cdot \Delta r \right) \right] + \gamma (\p\pr{{}^{0}\!{r},4} - \p\pr{{}^{N}\!{r},4}) + O(\p\pr{\Delta r,2}).
	\end{aligned}
...
\begin{equation}
	\begin{aligned}
	(EI)_{\infty} & = - \lim\limits_{N \to \infty} \sum_{n=1}^{N} \left[ \sum_{i \in \mathcal{L}} \alpha_i P_i (m_i + 2 ) \p\pr{{}^{n}\!{r},3} \Delta r \right] + \gamma (\p\pr{{}^{0}\!{r},4} - \p\pr{{}^{N}\!{r},4}) + O(\p\pr{\Delta r,2}) \\
	 & = - \sum_{i \in \mathcal{L}} \left( \int_{{}^{0}\!{r}}^{{}^{N}\!{r}} \alpha_i P_i (m_i + 2 ) \p\pr{r,3} \, dr \right) + \gamma (\p\pr{{}^{0}\!{r},4} - \p\pr{{}^{N}\!{r},4}) \\
...
\begin{subequations}
	\begin{align}
	& ~^{n}{\usf{B}} ~^{{n-1}}{\usf{A}}^{-1} ~^{{n-1}}{\usf{B}} = ~^{n}{\usf{A}} + \frac{\Delta r}{~^{n-1}\!{r}} \left( ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{n}{\usf{A}} - ~^{n}{\usf{A}} ~^{n}\tilde{\usf{m}} \right)  + O(\p\pr{\Delta r,2}), \\
	& ~^{n}{\usf{B}} ~^{{n-1}}{\usf{A}}^{-1} ~^{{n-1}}{\usf{D}} + ~^{n}{\usf{D}} = \frac{\Delta r}{~^{n-1}\!{r}} \left( 2~^{n}{\usf{D}} + ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{{n-1}}{\usf{D}} \right) + O(\p\pr{\Delta r,2}),
	\end{align}
	\label{eq:bnanm1}
\end{subequations}
...
\begin{aligned}
	\begin{split}
	~^{n}{\usf{A}} ~^{n}{\usf{K}} & = \left[  ~^{n}{\usf{A}} + \frac{\Delta r}{~^{n-1}\!{r}} \left( ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{n}{\usf{A}} - ~^{n}{\usf{A}} ~^{n}\tilde{\usf{m}} \right)  + O(\p\pr{\Delta r,2}) \right] ~^{{n-2}}{\usf{K}} \\
	& \qquad + \frac{\Delta r}{~^{n-1}\!{r}} \left( 2~^{n}{\usf{D}} + ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{{n-1}}{\usf{D}} \right) + O(\p\pr{\Delta r,2}),
	\end{split}
\end{aligned}
...
\begin{subequations}
	...
	\begin{split}
		~^{n}{\usf{B}} ~^{{n-1}}{\usf{A}}^{-1}
		& = ~^{n}{\usf{B}} \left[ ~^{n}\usf{B} - \delta ~^{n}\usf{B} \Delta r + O(\p\pr{\Delta r,2}) \right]^{-1} \\
		& = ~^{n}{\usf{B}} \left[ ~^{n}\usf{B} \left( \usf{I}_{4\times 4}- \frac{\Delta r}{~^{n-1}\!{r}} ~^{n-1}\tilde{\usf{m}} \right) + O(\p\pr{\Delta r,2}) \right]^{-1} \\
		& = ~^{n}{\usf{B}} \left[ \usf{I}_{4\times 4} - \frac{\Delta r}{~^{n-1}\!{r}} ~^{n-1}\tilde{\usf{m}} + O(\p\pr{\Delta r,2}) \right]^{-1} \usf{B}^{-1}_{n} \\
		& = \usf{I}_{4\times 4} + \frac{\Delta r}{~^{n-1}\!{r}} ~^{n}{\usf{B}}\  ~^{n-1}\tilde{\usf{m}}\  ~^{n}{\usf{B}}^{-1} + O(\p\pr{\Delta r,2}),
	\end{split}\\
	\begin{split}
		~^{n}{\usf{B}} ~^{{n-1}}{\usf{A}}^{-1} ~^{{n-1}}{\usf{B}}
		& = \left[ \usf{I}_{4\times 4} + \frac{\Delta r}{~^{n-1}\!{r}} ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} + O(\p\pr{\Delta r,2}) \right] \cdot \\
		& \qquad \left[ ~^{n}\usf{A} - \frac{\Delta r}{~^{n-1}\!{r}} ~^{n}{\usf{A}} ~^{n}\tilde{\usf{m}} + O(\p\pr{\Delta r,2}) \right] \\
		& = ~^{n}\usf{A} + \frac{\Delta r}{~^{n-1}\!{r}} \left( ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{n}\usf{A} - ~^{n}{\usf{A}} ~^{n}\tilde{\usf{m}} \right) + O(\p\pr{\Delta r,2}),
	\end{split} \\
	\begin{split}
		~^{n}{\usf{B}} ~^{{n-1}}{\usf{A}}^{-1} ~^{{n-1}}{\usf{D}} + ~^{n}{\usf{D}}
		& = \left[ \usf{I}_{4\times 4} + \frac{\Delta r}{~^{n-1}\!{r}} ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} + O(\p\pr{\Delta r,2}) \right] ~^{{n-1}}{\usf{D}} + ~^{n}{\usf{D}} \\
		& = ~^{{n-1}}{\usf{D}} + ~^{n}{\usf{D}} + \frac{\Delta r}{~^{n-1}\!{r}} ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{{n-1}}{\usf{D}} + O(\p\pr{\Delta r,2}) \\
		& = \frac{\Delta r}{~^{n-1}\!{r}} \left( 2~^{n}{\usf{D}} + ~^{n}{\usf{B}} ~^{n-1}\tilde{\usf{m}} ~^{n}{\usf{B}}^{-1} ~^{{n-1}}{\usf{D}} \right) + O(\p\pr{\Delta r,2}).
	\end{split}
	\end{align}
	\label{eq:C5}
\end{subequations}
