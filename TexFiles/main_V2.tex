...
\begin{figure}[t]
  ...
  \caption{Three-dimensional schematics of  $N$-layer cylindrical structure.~$\subf{A}$ General view and cross section view for $N = 1$.~$\subf{B}$ General view and cross section view for $N = 2$.~$\subf{C}$ General view and cross section view for $N = 3$.~$\subf{D}$ Cross-section view of an arbitrary $N$-layer cylindrical structure. Radii ${}^{0}\!{r},{}^{1}\!{r},\ldots,{}^{n-1}\!{r},\ldots,{}^{n}\!{r},\ldots,{}^{N-1}\!{r},{}^{N}\!{r}$ are marked in the figure.}
