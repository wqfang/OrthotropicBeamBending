...
\begin{subequations}
	\begin{align}
	& \sum_{i \in \mathcal{L}} \left( {}^{n}\!{K_{i}} \p\pr{{}^{n}\!{r},{}^{n}\!{m_{i}} - 2} - {}^{n+1}\!{K_{i}} \p\pr{{}^{n}\!{r},{}^{n+1}\!{m_{i}} - 2} \right) = {}^{n+1}\!{\mu_{1}}
  - {}^{n}\!{\mu_{1}}, \\
	& \sum_{i \in \mathcal{L}} \left( {}^{n}\!{K_{i}} {}^{n}\!{g_{i}} \p\pr{{}^{n}\!{r},{}^{n}\!{m_{i}} - 2} - {}^{n+1}\!{K_{i}} {}^{n+1}\!{g_{i}} \p\pr{{}^{n}\!{r},{}^{n+1}\!{m_{i}} - 2} \right) = {}^{n+1}\!{\mu_{2}} - {}^{n}\!{\mu_{2}}, \\
	& \sum_{i \in \mathcal{L}} \left( {}^{n}\!{K_{i}} {}^{n}\!{Q_{i}} \p\pr{{}^{n}\!{r},{}^{n}\!{m_{i}} - 2} - {}^{n+1}\!{K_{i}} {}^{n+1}\!{Q_{i}} \p\pr{{}^{n}\!{r},{}^{n+1}\!{m_{i}} - 2} \right) = {}^{n+1}\!{Q_{5}} - {}^{n}\!{Q_{5}}, \\
	& \sum_{i \in \mathcal{L}} \left( {}^{n}\!{K_{i}} {}^{n}\!{W_{i}} \p\pr{{}^{n}\!{r},{}^{n}\!{m_{i}} - 2} - {}^{n+1}\!{K_{i}} {}^{n+1}\!{W_{i}} \p\pr{{}^{n}\!{r},{}^{n+1}\!{m_{i}} - 2} \right) = {}^{n+1}\!{W_{5}} - {}^{n}\!{W_{5}},
	\end{align}
...
\begin{equation}
	...
	~^{n}{\usf{B}} = ~^{n-1}\tilde{\usf{A}}  ~^{n-1}\usf{f}({}^{n-1}\!r).
\end{equation}
...
where
	...
	\delta ~^{n}\usf{B} & = \frac{1}{~^{n-1}\!{r}} ~^{n}\usf{B} ~^{n-1}\tilde{\usf{m}} = \frac{1}{~^{n-1}\!{r}} ~^{n-1}\tilde{\usf{A}} ~^{n-1}\usf{f}({}^{n-1}\!r) ~^{n-1}\tilde{\usf{m}}.
	\end{align}
\label{eq:nMinus1AB}
\end{subequations}
...
\begin{equation}
    \begin{aligned}
        2 r_n \frac{d\, \Kodd(r_n)}{dr} = & \left( \Inv\pr{{}^{n}\usf{f}({}^{n}\!r)} \Inv\pr{{}^{n}\tilde{\usf{A}}} ~^{n-1}\tilde{\usf{A}} ~^{n-1}\tilde{\usf{m}} \Inv\pr{{}^{n-1}\tilde{\usf{A}}} \tilde{\usf{A}}_n ~^{n}\usf{f}({}^{n}\!r) - ~^{n}\tilde{\usf{m}} \right)\Kodd(r_n) \\
    & + \p\pr{{}^{n}\!{r},2} \Inv\pr{{}^{n}\usf{f}({}^{n}\!r)} \Inv\pr{{}^{n}\tilde{\usf{A}}} \left( -2\usf{I}_{4\times 4} + ~^{n-1}\tilde{\usf{A}} ~^{n-1}\tilde{\usf{m}} \Inv\pr{{}^{n-1}\tilde{\usf{A}}} \right) ~^{n}\tilde{\usf{D}} + O(\Delta r);
    \end{aligned}
\end{equation}
if $n$ is even,
\begin{equation}
    \begin{aligned}
    2 r_n \frac{d\, \Keven(r_n)}{dr} = & \left( \Inv\pr{{}^{n}\usf{f}({}^{n}\!r)} \Inv\pr{{}^{n}\tilde{\usf{A}}} ~^{n-1}\tilde{\usf{A}} ~^{n-1}\tilde{\usf{m}} \Inv\pr{{}^{n-1}\tilde{\usf{A}}} \tilde{\usf{A}}_n ~^{n}\usf{f}({}^{n}\!r) - ~^{n}\tilde{\usf{m}} \right)\Keven(r_n) \\
    & + \p\pr{{}^{n}\!{r},2} \Inv\pr{{}^{n}\usf{f}({}^{n}\!r)} \Inv\pr{{}^{n}\tilde{\usf{A}}} \left( -2\usf{I}_{4\times 4} + ~^{n-1}\tilde{\usf{A}} ~^{n-1}\tilde{\usf{m}} \Inv\pr{{}^{n-1}\tilde{\usf{A}}} \right) ~^{n}\tilde{\usf{D}} + O(\Delta r),
    \end{aligned}
\end{equation}
...
\begin{equation}
    ...
    :=
    \begin{bmatrix}
        {}^{\RN{1}}\!{\mu_{1}}-{}^{\RN{2}}\!{\mu_{1}} \\ {}^{\RN{1}}\!{\mu_{2}}-{}^{\RN{2}}\!{\mu_{2}}  \\ {}^{\RN{1}}\!{Q_{5}}-{}^{\RN{2}}\!{Q_{5}} \\ {}^{\RN{1}}\!{W_{5}}-{}^{\RN{2}}\!{W_{5}}.
    \end{bmatrix} .
\end{equation}
