...
\begin{equation}
	\begin{aligned}
	EI = & \sum_{n=1}^{N} \left[ \sum_{i \in \mathcal{J}} {}^{n}\!{\alpha_{i}} {}^{n}\!{K_{i}}  ({}^{n-1}\!{r}^{{}^{n}\!{m_{i}}+2} - {}^{n}\!{r}^{{}^{n}\!{m_{i}}+2}) + {}^{n}\!\gamma({}^{n-1}\!{r}^4 - {}^{n}\!{r}^4) \right],
	\end{aligned}
	\label{eq:EI}
\end{equation}
with
...
We use the stacking-sequence notation to describe the spatial arrangement of layers' helical angles. As per stacking-sequence notation, we use~$[{}^{0}\!\varphi]_N$ to denote a lamination scheme consisting of~$N$ layers and all layers have same helical angle,~${}^{0}\!\varphi$. For this lamination scheme, the material property of a material point does not change with its position in the cylinder. Thus the material is essentially homogeneous.
...
\begin{equation}
	\begin{aligned}
	\begin{split}
	EI & = \sum_{n=1}^{N} \bigg[ \sum_{i \in \mathcal{J}} {}^{n}\!{\alpha_{i}} \left( {}^{n}\!{P_{i}} {}^{n}\!{r}^{-{}^{n}\!{m_{i}} + 2} + O(\Delta r) \right) \cdot \\ & \qquad{} (- {}^{n}\!{r}^{{}^{n}\!{m_{i}}+1}({}^{n}\!{m_{i}} + 2 ) \Delta r + O(\Delta r^2))  + {}^{n}\!\gamma (-4 {}^{n}\!{r}^3 \Delta r + O(\Delta r^2)) \bigg] \\
	 & = -\sum_{n=1}^{N} \bigg[ \sum_{i \in \mathcal{J}} {}^{n}\!{\alpha_{i}} {}^{n}\!{P_{i}} ({}^{n}\!{m_{i}} + 2) + 4{}^{n}\!\gamma \bigg] {}^{n}\!{r}^3 \cdot \Delta r + O(\Delta r^2).
	\end{split}
	\end{aligned}
...
\begin{equation}
	\begin{aligned}
		EI & = -\sum_{\text{odd layers}} \bigg[ \sum_{i \in \mathcal{J}} {}^{I}\!{\alpha_{i}} {}^{I}\!{P_{i}} ({}^{I}\!{m_{i}} + 2) + 4{}^{I}\!\gamma \bigg] {}^{n}\!{r}^3 \cdot \Delta r \\ & \quad{} -\sum_{\text{even layers}} \bigg[ \sum_{i \in \mathcal{J}} {}^{II}\!{\alpha_{i}} {}^{II}\!{P_{i}} ({}^{II}\!{m_{i}} + 2) + 4{}^{II}\!\gamma \bigg] {}^{n}\!{r}^3 \cdot \Delta r + O(\Delta r^2) \\
		 & = -\frac{1}{2}
		 \bigg\lbrace
		 \sum_{n=1}^N \bigg[ \sum_{i \in \mathcal{J}} {}^{I}\!{\alpha_{i}} {}^{I}\!{P_{i}} ({}^{I}\!{m_{i}} + 2) + 4{}^{I}\!\gamma \bigg] {}^{n}\!{r}^3 \cdot \Delta r \\ & \quad\qquad{} + \sum_{n=1}^N \bigg[ \sum_{i \in \mathcal{J}} {}^{II}\!{\alpha_{i}} {}^{II}\!{P_{i}} ({}^{II}\!{m_{i}} + 2) + 4{}^{II}\!\gamma \bigg] {}^{n}\!{r}^3 \cdot \Delta r
...
\begin{equation}
	 \begin{aligned}
	   (EI)_{\infty} & = \frac{1}{2}  \Biggl \{
	   		- \Biggl[ \sum_{i \in \mathcal{J}} {}^{I}\!{\alpha_{i}} {}^{I}\!{P_{i}} ({}^{I}\!{m_{i}} + 2) + 4{}^{I}\!\gamma \Biggr]
			\int_{{}^{0}\!{r}}^{{}^{N}\!{r}} r^3 \, dr \\ & \quad\qquad{}
			- \Biggl[ \sum_{i \in \mathcal{J}} {}^{II}\!{\alpha_{i}} {}^{II}\!{P_{i}} ({}^{II}\!{m_{i}} + 2) + 4{}^{II}\!\gamma \Biggr]
			\int_{{}^{0}\!{r}}^{{}^{N}\!{r}} r^3 \, dr
	    \Biggl \} \\
...
where
\begin{equation}
	{}^{j}(EI)_{\infty} = - \frac{{}^{N}\!{r}^4 - {}^{0}\!{r}^4}{4} \left[ \sum_{i \in \mathcal{J}} {}^{j}\!{\alpha_{i}} {}^{j}\!{P_{i}} ({}^{j}\!{m_{i}} + 2 ) + 4{}^{j}\!\gamma\right], \quad \text{for} \, j = I, II.
\end{equation}
...
{}^{n}\!{K_{i}} = {}^{n}\!{r}^{-{}^{n}\!{m_{i}}} \left( {}^{n}\!G_{i0} {}^{n}\!r^2 + \sum_{j \in \mathcal{J}} {}^{n}\!G_{ij} {}^{n}\!r^{{}^{n}\!\lambda_{j}} \right), \quad \text{for}\, i \in \mathcal{J},
\label{eq:two_mat_no_slip_Ks}
\end{equation}
where~${}^{n}\!G_{ij}$ ($j = \text{0 to 4}$) and~${}^{n}\!\lambda_{j}$ ($j \in \mathcal{J}$) given by Eqn.~\eqref{eq:Gjin} are constants related to material constants of the~$n^{\text{th}}$ layer.
Substituting Eqn.~\eqref{eq:two_mat_no_slip_Ks} into Eqn.~\eqref{eq:EI}, we obtain the bending stiffness as
\begin{equation}
\begin{aligned}
	EI & = - \sum_{n=1}^{N} \left\lbrace \sum_{i \in \mathcal{J}} {}^{n}\!{\hat{\alpha}_{i}} \left( {}^{n}\!G_{i0} {}^{n}\!r^2 + \sum_{j \in \mathcal{J}} {}^{n}\!G_{ij} {}^{n}\!r^{{}^{n}\!\lambda_{j}} \right) {}^{n}\!{r} + 4{}^{n}\!\gamma~ {}^{n}\!{r}^3 \right\rbrace + O(\Delta r) \\
	& =  - \sum_{n=1}^{N} \left\lbrace \left( \sum_{i \in \mathcal{J}} {}^{n}\!{\hat{\alpha}_{i}} {}^{n}\!G_{i0} + 4{}^{n}\!\gamma \right) {}^{n}\!{r}^3+ \sum_{i \in \mathcal{J}} \sum_{j \in \mathcal{J}} {}^{n}\!{\hat{\alpha}_{i}} {}^{n}\!G_{ij} {}^{n}\!r^{1 + {}^{n}\!\lambda_{j}} \right\rbrace + O(\Delta r),
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
	EI & =  - \frac{1}{2} \sum_{n=1}^{N} \left[ \left( \sum_{i \in \mathcal{J}} {}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{i0} + 4{}^{I}\!\gamma \right) {}^{n}\!{r}^3+ \sum_{i \in \mathcal{J}} \sum_{j \in \mathcal{J}} {}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{ij} r^{1 + {}^{I}\!\lambda_{j}}_n \right] \\
	 & \quad - \frac{1}{2} \sum_{n=1}^{N} \biggr[ \left( \sum_{i \in \mathcal{J}} {}^{II}\!\hat{\alpha}_{i} {}^{II}\!G_{i0} + 4{}^{II}\!\gamma \right) {}^{n}\!{r}^3 \\
	  & \qquad \qquad \qquad \qquad + \sum_{i \in \mathcal{J}} \sum_{j \in \mathcal{J}} {}^{II}\!\hat{\alpha}_{i} {}^{II}\!G_{ij} r^{1 + {}^{II}\!\lambda_{j}}_n \biggr] + O(\Delta r).
\end{aligned}
\end{equation}
As~$N \to \infty$, we obtain the asymptotic bending stiffness as
\begin{equation}
\begin{aligned}
	(EI)_{\infty} & =  - \frac{1}{2} \left[ \sum_{i \in \mathcal{J}} \left( {}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{i0} + {}^{II}\!\hat{\alpha}_{i} {}^{II}\!G_{i0} \right) + 4\left( {}^{I}\!\gamma +{}^{II}\!\gamma \right) \right] \int_{{}^{0}\!{r}}^{{}^{N}\!{r}} r^3 \, dr \\
	& \quad - \frac{1}{2} \sum_{i \in \mathcal{J}} \sum_{j \in \mathcal{J}} \left[ \int_{{}^{0}\!{r}}^{{}^{N}\!{r}} \left( {}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{ij} r^{1 + {}^{I}\!\lambda_{j}} + {}^{II}\!\hat{\alpha}_{i} {}^{II}\!G_{ij}  r^{1 + {}^{II}\!\lambda_{j}} \right) \, dr \right] \\
	& = - \frac{1}{8} \left[ \sum_{i \in \mathcal{J}} \left( {}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{i0} + {}^{II}\!\hat{\alpha}_{i} {}^{II}\!G_{i0} \right) + 4\left( {}^{I}\!\gamma +{}^{II}\!\gamma \right) \right] \left( {}^{N}\!{r}^4 - {}^{0}\!{r}^4 \right) \\
	& \quad - \frac{1}{2} \sum_{i \in \mathcal{J}} \sum_{j \in \mathcal{J}} \biggr[ \frac{{}^{I}\!\hat{\alpha}_{i} {}^{I}\!G_{ij}}{2 + {}^{I}\!\lambda_{j} } \left( {}^{N}\!{r}^{2 + {}^{I}\!\lambda_{j}} - {}^{0}\!{r}^{2 + {}^{I}\!\lambda_{j}} \right) \\
...
% \begin{equation}
% 	~^{n}\tilde{\usf{A}} ~^{n}{\hat{\usf{K}}} = ~^{n}\tilde{\usf{B}} ~^{{n-1}}{\usf{K}}^e + r^2 ~^{n}\tilde{\usf{D}}.
% \end{equation}
...
\begin{subequations}
\begin{align}
	{}^{n}\!G_{i0}& := \sum_{k \in \mathcal{J}} \pr{~^{n}\tilde{\usf{Q}}}^{-1}_{ik} \frac{{}^{n}\!L_{k}}{2 - {}^{n}\!\lambda_{k}}, \\
	{}^{n}\!G_{ij}& := \pr{~^{n}\tilde{\usf{Q}}}^{-1}_{ij} {}^{n}\!c_{j}, \quad \text{for}\, j\in \mathcal{J} .
\end{align}
\label{eq:Gjin}
\end{subequations}
