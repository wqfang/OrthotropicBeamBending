...
\usepackage{amssymb,amsmath,gensymb,amsthm}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{./figure/Laminatedbiomaterials.pdf}
...
\begin{equation}
%K_{i,n} = r_n^{-m_{i,n}} \left( G^0_{i,n} r^2_n + G^1_{i,n} r^{\lambda_{1,n}}_n + G^2_{i,n} r^{\lambda_{2,n}}_n + G^3_{i,n} r^{\lambda_{3,n}}_n + G^4_{i,n} r^{\lambda_{4,n}}_n \right)
